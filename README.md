...
POSTECH PSI 연소 시험 결과를 정리하고 공개하는 저장소입니다.

Markdown 기록을 기본 공개 자료로 유지하고, 웹페이지는 같은 자료를 더 읽기 쉬운 형태로 보여 주는 보조 화면으로 제공합니다.
...
- 4월 8일 연소 시험
  - Markdown: [https://github.com/postech-psi/test-results/blob/main/tests/2026-04-08/index.md](https://github.com/postech-psi/test-results/blob/main/tests/2026-04-08/index.md)
  - 웹페이지: [https://postech-psi.github.io/test-results/tests/2026-04-08/index.html](https://postech-psi.github.io/test-results/tests/2026-04-08/index.html)
...
- 2026년 4월 3일 연소 시험
  ...
  - 웹페이지: [https://postech-psi.github.io/test-results/tests/2026-04-03/index.html](https://postech-psi.github.io/test-results/tests/2026-04-03/index.html)
